...
const galleryImages: string[] = [
  ...
  'bg-gallery-13',
  'bg-gallery-14',
  // 'https://static.eyeconnectglobal.com/gallery/gallery-1.jpg',
  // 'https://static.eyeconnectglobal.com/gallery/gallery-2.jpg',
  // 'https://static.eyeconnectglobal.com/gallery/gallery-3.jpg',
  // 'https://static.eyeconnectglobal.com/gallery/gallery-4.jpg',
  // 'https://static.eyeconnectglobal.com/gallery/gallery-5.jpg',
  // 'https://static.eyeconnectglobal.com/gallery/gallery-6.jpg',
  // 'https://static.eyeconnectglobal.com/gallery/gallery-7.jpg',
  // 'https://static.eyeconnectglobal.com/gallery/gallery-8.jpg',
  // 'https://static.eyeconnectglobal.com/gallery/gallery-9.jpg',
  // 'https://static.eyeconnectglobal.com/gallery/gallery-10.jpg',
  // 'https://static.eyeconnectglobal.com/gallery/gallery-11.jpg',
  // 'https://static.eyeconnectglobal.com/gallery/gallery-12.jpg',
  // 'https://static.eyeconnectglobal.com/gallery/gallery-13.jpg',
  // 'https://static.eyeconnectglobal.com/gallery/gallery-14.jpg',
];
{
  /* <div
  className={cn(
